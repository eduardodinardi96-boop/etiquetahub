...
function orderView(o, user) {
  ...
  return {
    ...
    carrier: meta.carrier || null, dispatch_by: meta.dispatch_by || null, ship_type: ({ self_service: 'Flex', cross_docking: 'Colecta', drop_off: 'Agencia', xd_drop_off: 'Agencia', fulfillment: 'Full' })[meta.logistic] || null, customer: meta.customer || '', tracking: meta.tracking || null, track_url: trackUrl(o, meta, user),
  };
}
